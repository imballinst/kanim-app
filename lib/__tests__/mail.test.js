...
describe('mail component (lib/mail)', () => {
  ...
  it('should correctly build html and text object', () => {
    ...
    const html2 = `Halo!<br><br>Telah tersedia kuota untuk <b>${officeName}</b> pada tanggal: <ol>` +
      `<li>01 Januari 2018 (pagi: <b>16</b> orang, siang: <b>23</b> orang)</li>` +
      `<li>02 Januari 2018 (pagi: <b>17</b> orang, siang: <b>24</b> orang)</li>` +
      `</ol><br>${endingWords}`;
...
describe('mail counter (lib/mail)', () => {
  it('should test all functions', () => {
    expect(Object.keys(untestedFunctions).length).toBe(0);
    expect(counter).toBe(Object.keys(mailFunctions).length);
  });
});
